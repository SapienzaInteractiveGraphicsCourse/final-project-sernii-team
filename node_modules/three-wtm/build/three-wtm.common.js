...
class GeometryTransport extends DataTransport {
  ...
  setGeometry(geometry, geometryType) {
    ...
    if (geometry instanceof three.BufferGeometry) this.main.bufferGeometry = geometry;
    return this;
  }
  /**
  ...
  reconstruct(cloneBuffers) {
    if (this.main.bufferGeometry instanceof three.BufferGeometry) return this;
    this.main.bufferGeometry = new three.BufferGeometry();
    ...
    if (index !== null && index !== undefined) {
      ...
      this.main.bufferGeometry.setIndex(new three.BufferAttribute(indexBuffer, index.itemSize, index.normalized));
    }

    const boundingBox = transferredGeometry.boundingBox;
    if (boundingBox !== null) this.main.bufferGeometry.boundingBox = Object.assign(new three.Box3(), boundingBox);
    const boundingSphere = transferredGeometry.boundingSphere;
    if (boundingSphere !== null) this.main.bufferGeometry.boundingSphere = Object.assign(new three.Sphere(), boundingSphere);
  ...
  _assignAttribute(attr, attrName, cloneBuffer) {
    if (attr) {
      ...
      this.main.bufferGeometry.setAttribute(attrName, new three.BufferAttribute(arrayBuffer, attr.itemSize, attr.normalized));
    }
...
class MaterialStore {
  ...
  constructor(createDefaultMaterials) {
    ...
    if (createDefaultMaterials) {
      ...
      const defaultPointMaterial = new three.PointsMaterial({
        size: 0.1
      });
...
exports.GeometryTransport = GeometryTransport;
exports.MaterialStore = MaterialStore;
exports.MaterialUtils = MaterialUtils;
exports.MaterialsTransport = MaterialsTransport;
exports.MeshTransport = MeshTransport;
exports.ObjectManipulator = ObjectManipulator;
exports.ObjectUtils = ObjectUtils;
exports.WorkerTaskManager = WorkerTaskManager;
exports.WorkerTaskManagerDefaultRouting = WorkerTaskManagerDefaultRouting;
